...
public class TaskUnitInfo {
	...
	private String taskUnitNodePath;
	...
	public String getTaskUnitNodePath() {
		return taskUnitNodePath;
	}

	public void setTaskUnitNodePath(String taskUnitNodePath) {
		this.taskUnitNodePath = taskUnitNodePath;
	}
