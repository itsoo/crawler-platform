...
public class GsonUtils {
	...
	public final static String MAP_KEY_SELF_MESSION_PATH = "messionPath";
	...
	public final static String getSelfNodeValue(String selfIp,
		...
		map.put(MAP_KEY_SELF_MESSION_PATH, selfMessionNodePath);
	...
	public final static List<List<TaskParamInfo>> getTaskParamsList(String str) {
		return gson.fromJson(str, new TypeToken<List<List<TaskParamInfo>>>() {
		}.getType());
	}
}